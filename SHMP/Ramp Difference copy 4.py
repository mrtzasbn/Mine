...
file = r'D:\Data\CERN\R192-5\SHMP\Ramp\hc1_ramp2090.dat'
title = "Ramp for 2090"
...
for interval, (start, end) in enumerate(intervals):
    ...
    difference = (y_fit - hall_constant['Hall_Voltage(V)']) * 1000
    ...
    ax.annotate(
        f'Start of Deviation: ({linear(x_data[first_index], params[0], params[1])*1000:.2f} mT)',
...
for point in intersection_points:
    ...
    ax.annotate(
        f'Field$_i$$_n$$_t$: ({point["Intersection"][1]*1000:.2f} mT)',
