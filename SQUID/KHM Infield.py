...
title = "Nb$_3$Sn Thin Film, Sample 168-5, KHM Infield"
...
interp_func = interp1d(df_infield['Field (Oe)'], df_infield['Long Moment (emu)'], kind='cubic')
...
ax.scatter(df_infield['Field (Oe)']/10, df_infield['Long Moment (emu)'], color="black", label="SQUID Data")
