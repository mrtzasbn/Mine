...
for i, df_chunk in enumerate(dfs):
    ...
    ax.plot(df_chunk['Field (Oe)']/10, df_chunk[str]*1E6, label=f"ac {i+1}", marker="o")
...
plt.savefig(title + 'Departed.pdf', format='pdf', bbox_inches='tight')
plt.savefig(title + 'Departed.png', format='png', bbox_inches='tight')
plt.show()
